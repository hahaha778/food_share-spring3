<template>
    <el-row style="width: 1000px;background-color: rgb(255,255,255);border-radius: 2px;margin: 0 auto;">
        ...
        <el-col :span="8" style="padding: 10px 20px;position: sticky;top: 60px;">
            <!-- <h4 style="margin-top: 10px;">猜你想看</h4>
            <div style="display: flex;justify-content: left;" class="item-gourmet"
                v-for="(gourmet, index) in recommendGourmet" :key="index">
                <div class="left">
                    <img :src="gourmet.cover">
                </div>
                <div class="right">
                    <div class="info">
                        <img style="width: 14px;height: 14px;border-radius: 7px;" :src="gourmet.userAvatar" alt="">
                        <span>{{ gourmet.userName }}</span>
                    </div>
